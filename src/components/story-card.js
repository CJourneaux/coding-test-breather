...
export default function StoryCard({
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {author}
            </Link>, <Tooltip hasArrow label={creationDate.format('dddd D MMMM YYYY, HH:mm')} placement="top" >
      ...
      <Icon name='chevron-right' size='2rem' height='unset' color='purple.900' />
    </PseudoBox >
  );
